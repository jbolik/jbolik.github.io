...
Since we are virtually always in the misspecified setting in practice, this leads to applied Bayesian statisticians frequently drawing misleading conclusions from their credible intervals, and unlike in the Frequentist case, there is no clean solution. However, there are some recent ideas around using post hoc posterior recalibrations as well as generalized Bayes approaches.
